...
export class RecipeEditComponent implements OnInit {
  ...
  onSubmit() {
    ...
    const cooking = this.recipeForm.value.cooking;
    const portion = this.recipeForm.value.portion;
    const time = this.recipeForm.value.time;

    const newRecipe = new Recipe(name, description, imagePath, cooking, portion, time, ingredients);
  ...
  private initForm() {
    ...
    this.recipeForm = new FormGroup({
      ...
      cooking: new FormControl(recipeCooking, Validators.required),
      portion: new FormControl(recipePortion, Validators.required),
      time: new FormControl(recipeTime, Validators.required),
